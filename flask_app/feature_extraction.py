...
def extract_features_video(path):
    ...
    # Load the predictor
    predictor = dlib.shape_predictor("C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/static/img_dataset/shape_predictor_68_face_landmarks.dat")
...
def video_prediction(path):
    ...
    model =load_model("C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/static/img_dataset/image_emotions_model_test.h5")
...
def image_prediction(path):
    ...
    # Load label encoder
    labelencoder_filename = 'C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/static/img_dataset/label_encoder.pk'
...
def audio_prediction(path):
    ...
    filename = 'C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/static/voice_dataset/voice_emotions_model.sav'
...
def text_cleaning(data):
    ...
    model_filename = 'C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/static/text_dataset/text_emotions_model.sav'
    model = pickle.load(open(model_filename, 'rb'))

    # load the vectorizer from disk
    vectorizer_filename = 'C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/static/text_dataset/tfidf_vect.pk'
...
def feedback(text):
    import pandas as pd
    df = pd.read_csv('C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/feedbacks.csv')
    ...
    df3.to_csv('C:/Users/abhis/OneDrive/Desktop/EmoScript/EmoScript/flask_app/feedbacks.csv', index=False, date_format='%Y-%m-%d %H:%M:%S')
